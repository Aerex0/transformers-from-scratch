...
class DecoderBlock(nn.Module):
    def __init__(self, d_model=D_MODEL, n_heads=N_HEADS, encoder_output=None):
        super().__init__()
        ...
        self.multi_head_attn = MultiHeadAttention(d_model, n_heads, cross_attention=True, encoder_output=encoder_output).to(DEVICE)
